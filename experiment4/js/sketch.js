...
/////////////////////////////
function preload(){
  shipDL = loadImage('./img/ship7.png');
  console.log(shipDL);
  shipUR = loadImage('./img/ship15.png');
  console.log(shipUR);
  shipUL = loadImage('./img/ship3.png');
  console.log(shipUL);
  shipDR = loadImage('./img/ship11.png');
  console.log(shipDR);
  waveDL = loadImage('./img/wave1.png');
  console.log(waveDL);
  waveUR = loadImage('./img/wave2.png');
  console.log(waveUR);
  waveUR1 = loadImage('./img/Wave_light.png');
  console.log(waveUR1);
  waveUR2 = loadImage('./img/Wave_blue.png');
  console.log(waveUR2);
  waveUR3 = loadImage('./img/Wave_dark.png');
  console.log(waveUR3);
